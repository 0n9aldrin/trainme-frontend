...
import com.trainme.jerald.frontend.components.adapters.MyRequestStatusAdapter;
...
public class MyRequestStatusActivity extends BaseActivity implements MyRequestSparringStatusContract.View {

    @Inject
    MyRequestSparringStatusController mController;
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    @BindView(R.id.spinnerIcon)
    IconTextView spinner;
    MyRequestStatusAdapter mAdapter;
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, MyRequestStatusActivity.class);
    }
    ...
    public void getDataSuccess(List<MyRequestSparringStatus> data) {
        mAdapter = new MyRequestStatusAdapter(getApplicationContext(),data);
