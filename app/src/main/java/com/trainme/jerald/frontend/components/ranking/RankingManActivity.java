...
import com.trainme.jerald.frontend.components.adapters.RankingManAdapter;
...
public class RankingManActivity extends BaseActivity implements RankingContract.View,
        RankingManAdapter.OnClickListener  {

    @Inject
    RankingManController mController;
    @BindView(R.id.recyclerView)
    RecyclerView recyclerView;
    @BindView(R.id.spinnerIcon)
    IconTextView spinner;
    RankingManAdapter mAdapter;
    ...
    public static Intent createIntent(Context context) {
        return new Intent(context, RankingManActivity.class);
    }

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_ranking_man);
    ...
    public void getDataSuccess(List<Ranking> data) {
        mAdapter = new RankingManAdapter(getApplicationContext(),data, this);
