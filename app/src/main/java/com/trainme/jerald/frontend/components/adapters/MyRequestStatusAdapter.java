...
public class MyRequestStatusAdapter extends RecyclerView.Adapter<MyRequestStatusAdapter.MyViewHolder> {
    private List<MyRequestSparringStatus> listData;
    private LayoutInflater layoutInflater;
    Context mContext;
    public MyRequestStatusAdapter(Context context, List<MyRequestSparringStatus> listData) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View itemView = LayoutInflater.from(parent.getContext()).inflate(R.layout.layout_my_request,
                parent, false);
        return new MyRequestStatusAdapter.MyViewHolder(itemView);
    }
