...
public class RankingManService implements RankingContract.Service {
    ...
    public RankingManService(AppComponent appComponent) {
    ...
    @Override
    public void getData() {
        Call<ResponseRanking> call = mService.getManRanking();
