...
public class MyRequestCoachingStatusController implements MyRequestCoachingStatusContract.Controller {
    @Inject
    Realm realm;

    @Inject
    MyRequestCoachingStatusService mService;

    private MyRequestCoachingStatusContract.View views;

    public MyRequestCoachingStatusController(@NonNull AppComponent appComponent) {
        appComponent.inject(this);
    }

    public void setView(MyRequestCoachingStatusContract.View view) {
        views = view;
    }
