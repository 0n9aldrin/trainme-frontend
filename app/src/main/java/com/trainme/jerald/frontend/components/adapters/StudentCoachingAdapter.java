...
public class StudentCoachingAdapter extends RecyclerView.Adapter<StudentCoachingAdapter.MyViewHolder> {
    private List<SparringInvitation> listData;
    private LayoutInflater layoutInflater;
    Context mContext;
    private OnClickListener onClickItem;
    public StudentCoachingAdapter(Context context, List<SparringInvitation> listData, OnClickListener onClickItem) {
        mContext = context;
    ...
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        ...
        return new StudentCoachingAdapter.MyViewHolder(itemView);
    }
