...
import com.trainme.jerald.frontend.components.adapters.KebijakanPrivasiAdapter;
...
public class KebijakanPrivasiActivity extends BaseActivity implements KebijakanPrivasiContract.View {

    @Inject
    KebijakanPrivasiController mController;
    ...
    List<KebijakanPrivasi> listData = Collections.EMPTY_LIST;
    ...
    public KebijakanPrivasiAdapter mAdapter;
    public static Intent createIntent(Context context) {
        return new Intent(context, KebijakanPrivasiActivity.class);
    }
    @Override
    ...
    public void getDataSuccess(List<KebijakanPrivasi> data) {
        listData = data;
        mAdapter = new KebijakanPrivasiAdapter(getApplicationContext(), listData);
